...
$manifest = [ordered]@{
    ...
    releaseNotes = 'SnapAnchor 2.1.0 improves long scrolling capture, introduces a warm neutral and charcoal interface with a matching app icon, and adds direct History navigation back to the dashboard.'
}
