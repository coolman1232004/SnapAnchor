...
<p align="center">
  ...
  <img alt="Current version" src="https://img.shields.io/badge/version-2.1.18-292524">
...
- Pixel-exact native pins with source-preserving linear rendering and exact physical-pixel zoom steps
...
```powershell
.\packaging\Build-Packages.ps1 -Version 2.1.18
```
